...
`,
    ...
    .option(
      "--set-api-key <apiKey>",
      "Set your API key. After purchasing a subscription you can copy and paste the command shown on the page",
    )
    .option(
      "--unreserve-subdomain <subdomain>",
      "Unreserve a subdomain, for example if the number of subdomains you have reserved exceeds your limit",
    )
